"""
Django settings for ctp_site project.
...
SECRET_KEY = "django-insecure-hequ=h82!u=$)dfsp*3b6@7(t3jqwu(lw!u6wfrqio*mla4yc8"
...
WSGI_APPLICATION = "ctp_site.wsgi.application"
